...
program main
  ...
  !! date: 2/7/2020
  !! Test the computation of spatial derivatives on a 2D cylindrical structured_grid
  ...
  !character(len=*), parameter:: input_file = "2Dcylinder.json"
  character(len=*), parameter:: input_file = "3Dplate-high-resolution-layers.json"
  character(len=*), parameter:: base_name = "2Dcylinder-derivatives"

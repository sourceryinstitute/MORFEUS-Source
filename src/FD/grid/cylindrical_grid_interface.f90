...
!
module cylindrical_grid_interface
  !! author: Damian Rouson and Karla Morris
  !! date: 2/7/2020
  !! subject: perform coordinate-specific tasks on cylindrical structured_grid objects
  ...
  private
  public :: cylindrical_grid

  type, extends(structured_grid) :: cylindrical_grid
    type(cylindrical_grid), allocatable :: scale_factor
  contains

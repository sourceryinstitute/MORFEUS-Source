...
if(NOT MPI_Fortran_FOUND)
  if(NOT WIN32)
	...
	TLS_VERIFY ON
	SOURCE_DIR "${TPLs}/src/MPICH-src"
	UPDATE_COMMAND ""
	CONFIGURE_COMMAND "${TPLs}/src/MPICH-src/configure" --enable-cache --enable-base-cache --disable-dependency-tracking --disable-cxx --enable-fortran=all

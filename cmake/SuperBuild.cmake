...
ExternalProject_Add( netcdf4
  DEPENDS hdf5
  SOURCE_DIR ${CMAKE_SOURCE_DIR}/netcdf
...
if( CMAKE_SYSTEM_NAME MATCHES "[Ll]inux|[Dd]arwin" )
  ...
  ExternalProject_Add( exodus
    ...
    BUILD_IN_SOURCE OFF
    CONFIGURE_COMMAND INSTALL_PATH=${TPL_DIR} ACCESS=${TPL_DIR}/src/exodus SHARED=OFF COMPILER=EXTERNAL FORTRAN=ON STATIC=ON ./cmake-exodus
    TEST_BEFORE_INSTALL ON

...
ExternalProject_Add( netcdf4
  ...
  CMAKE_CACHE_ARGS ${DEFAULT_CACHE_ARGS} -DBUILD_TESTING:BOOL=OFF -DENABLE_TESTS:BOOL=OFF -DENABLE_NETCDF_4:BOOL=ON -DENABLE_DOXYGEN:BOOL=OFF -DENABLE_DAP:BOOL=OFF -DENABLE_EXAMPLES:BOOL=OFF -DENABLE_V2_API:BOOL=OFF -DENABLE_CDF5:BOOL=ON -DHDF5_INCLUDE_DIR:PATH=${TPL_DIR}/include
  BUILD_IN_SOURCE OFF
  TEST_BEFORE_INSTALL ON)
...
if( CMAKE_SYSTEM_NAME MATCHES "[Ll]inux|[Dd]arwin" )
  ...
  ExternalProject_Add( exodus
    ...
    BUILD_IN_SOURCE OFF
    CONFIGURE_COMMAND pwd && ACCESS=${CMAKE_SOURCE_DIR}/exodus INSTALL_PATH=${TPL_DIR} PYTHON_VER=2.7 COMPILER=EXTERNAL STATIC=ON ${CMAKE_SOURCE_DIR}/exodus/cmake-exodus -DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=ON
    TEST_BEFORE_INSTALL ON
    )
endif()
